package com.thirtygames.zero.admin.controller.blood;
...
@Slf4j
@Controller
@RequestMapping(value = "/blood/event")
public class BloodMetaController extends AdminGridController<AdminBossRaidMeta, String, AdmBossRaidMetaService, BossRaidMetaValidator> {
	
	@Autowired
	AdmMissionNameMetaService nameMetaService;
	
	public BloodMetaController() {
