...
import com.thirtygames.zero.common.service.admintool.event.AdmCouponService;

@Slf4j
@Controller
@RequestMapping(value = "/event/coupon")
public class CouponController extends AdminGridController<AdminCoupon, String, AdmCouponService, CouponValidator> {
	
	public CouponController() {
		pageInfo.setTitle("Coupon");
	...
	public AdminMenu adminMenu() {
		...
		adminMenu.setSelectMenu("Coupon");
		return adminMenu;
	}	
	
	protected ModelMap postGrid(ModelMap model) {
		super.setViewName("event/couponList");
