	...
	<@layout.put block="page-javascript-inline">
		...
		<script type="text/javascript">
			$("#shardIndex").change(function() {
				location.href = "${rc.contextPath}/log/resource/grid/" + this.value;
			});
			...
			var serverUrl = {
				unitLogGrid : "${rc.contextPath}/log/resource/grid/${shardIndex}",
				unitLogGridEdit : "${rc.contextPath}/log/resource/grid/edit/${shardIndex}",
				unitLogExcel : "${rc.contextPath}/log/resource/excel/${shardIndex}",
				unitLogCsv : "${rc.contextPath}/log/resource/csv/${shardIndex}"
			}
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					colNames:['Key', '유저Id', '구분', '골드', '루비', '전장의날개', '결투의검', '우정포인트', '열쇠', '장비강화제', '장비뽑기권', '기록일시' ],					
					colModel:[
						...
						{name:'status', index:'status', width:100, fixed:true, sorttype:"string", editable: false, search:true, sortable:false, formatter: "select", edittype:"select", editoptions:{value:"0:소진;1:축적"}, search:false, sortable:true},
						
						{name:'gold', index:'gold', width:100, fixed:true, sorttype:"integer", editable: true, search:false, sortable:false},
						{name:'cash', index:'cash', width:100, fixed:true, sorttype:"integer", editable: true, search:false, sortable:false},
						{name:'ap', index:'ap', width:100, fixed:true, sorttype:"integer", editable: true, search:false, sortable:false},
						{name:'bp', index:'bp', width:100, fixed:true, sorttype:"integer", editable: true, search:false, sortable:false},
						{name:'fp', index:'fp', width:100, fixed:true, sorttype:"integer", editable: true, search:false, sortable:false},
						{name:'unlockKey', index:'unlockKey', width:100, fixed:true, sorttype:"integer", editable: true, search:false, sortable:false},
						{name:'equipLevelUpDrog', index:'equipLevelUpDrog', width:100, fixed:true, sorttype:"integer", editable: true, search:false, sortable:false},
						{name:'equipTicket', index:'equipTicket', width:100, fixed:true, sorttype:"integer", editable: true, search:false, sortable:false},
