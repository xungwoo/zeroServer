<@layout.extends name="/layout/base.ftl">
						...
						<div class="page-header">
							<h1>
								...
								<small>
									...
									래더 AI 정보를 설정합니다.<br>
									<span style="color:red;">국가 Code 는 수정되지 않습니다. 삭제 후 추가해주세요!!</span>
								</small>
							</h1>
						</div><!-- /.page-header -->
	...
	<@layout.put block="page-javascript-inline">
		...
		<script type="text/javascript">
			...
			var serverUrl = {
				ladderGrid : "${rc.contextPath}/league/country/grid",
				ladderGridEdit : "${rc.contextPath}/league/country/grid/edit"
			}
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					mtype: "POST",
					datatype: "json",
					colNames:[' ', 'key', '국가 Code', 'AI 여부', '수정일시', '수정ID'],					
					colModel:[
						...
						{name:'countryCode', index:'countryCode', width:150, fixed:true, sorttype:"integer", hidden: true, key: true, editable: true, searchoptions:{sopt: ['eq']}},
						{name:'countryCode', index:'countryCode', width:150, fixed:true, sorttype:"integer", key: true, editable: true, searchoptions:{sopt: ['eq']}},
						{name:'isLadderAI', index:'isLadderAI', width:100, fixed:true, formatter:"select", editable: true, edittype:"select", editoptions:{value:'true:true;false:false'}, search:false, sortable:false},
