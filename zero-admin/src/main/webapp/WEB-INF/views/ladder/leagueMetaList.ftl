		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					mtype: "POST",
					datatype: "json",	// metaKey, league, costBp, goldBonus4Regame, rewardType, rewardWinner, rewardLooser, leagueUp, leagueDown, modYmdt, modId
					colNames:[' ', 'metaKey', 'league', 'costBp', 'goldBonus4Regame', 'rewardType', 'rewardWinner', 'rewardLooser', 'leagueUp', 'leagueDown', 'modId', 'modYmdt'],					
					colModel:[
                        ...
                        {name:'league', index:'league', width:70, fixed:true, sorttype:"integer", editable: true, editrules: {required: true, number: true}, searchoptions:{sopt: ['eq']},sortable:true, search:true },
                        {name:'costBp', index:'costBp', width:70, fixed:true, sorttype:"integer", editable: true, editrules: {required: true, number: true}, searchoptions:{sopt: ['eq']}, sortable:true, search:true },
                        {name:'goldBonus4Regame', index:'goldBonus4Regame', width:100, fixed:true, sorttype:"integer", editable: true, editrules: {required: true, number: true}, searchoptions:{sopt: ['eq']}, sortable:true, search:true },
                        {name:'rewardType', index:'rewardType', width:100, fixed:true, sorttype:"integer", editable: true, editrules: {required: true, number: true}, searchoptions:{sopt: ['eq']}, sortable:true, search:true },
                        {name:'rewardWinner', index:'rewardWinner', width:100, fixed:true, sorttype:"integer", editable: true, editrules: {required: true, number: true}, searchoptions:{sopt: ['eq']}, sortable:true, search:true },
                        {name:'rewardLooser', index:'rewardLooser', width:100, fixed:true, sorttype:"integer", editable: true, editrules: {required: true, number: true}, searchoptions:{sopt: ['eq']}, sortable:true, search:true },
                        {name:'leagueUp', index:'leagueUp', width:80, fixed:true, sorttype:"integer", editable: true, editrules: {required: true, number: true}, searchoptions:{sopt: ['eq']}, sortable:true, search:true },
                        {name:'leagueDown', index:'leagueDown', width:80, fixed:true, sorttype:"integer", editable: true, editrules: {required: true, number: true}, searchoptions:{sopt: ['eq']}, sortable:true, search:true },
                        {name:'modId', index:'modId', width:100, fixed:true, sorttype:"integer", editable: false, },
                        {name:'modYmdt', index:'modYmdt', width:150, fixed:true, sorttype:"integer", editable: false}
