						...
						<div class="page-header">
							<h1>
								...
								<small>
									...
									BossCollection Meta 정보를 관리합니다.<br>
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					mtype: "POST",
					datatype: "json",		// metaKey, collectionId, bossMetaIds, title, difficulty, rewardType, reward, modYmdt, modId
					colNames:[' ', 'key', 'collectionId', 'bossMetaIds', 'title', 'difficulty', 'rewardType', 'reward', '수정일시', '수정ID' ],					
					colModel:[
						...
						{name:'collectionId', index:'collectionId', width:120, fixed:true, sorttype:"string", editable: true, sortable:false, search:false, searchoptions:{sopt: ['eq']}},
						{name:'bossMetaIds', index:'bossMetaIds', width:120, fixed:true, sorttype:"string", editable: true, searchoptions:{sopt: ['eq']}, sortable:true},
						
						{name:'title', index:'title', width:70, fixed:true, sorttype:"integer", editable: true, searchoptions:{sopt: ['eq']}, sortable:true},
						{name:'difficulty', index:'difficulty', width:60, fixed:true, sorttype:"integer", editable: true, searchoptions:{sopt: ['eq']}, sortable:true},
