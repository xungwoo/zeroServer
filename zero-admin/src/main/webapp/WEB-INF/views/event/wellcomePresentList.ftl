	...
	<@layout.put block="content">
					...
					<div class="page-content">
						<div class="page-header">
							<h1>
								복귀환영 보상 관리 (Wellcome Reward) 
								<small>
									<i class="icon-double-angle-right"></i>
									마지막 로그인 시간으로부터 일정 시간만에 복귀한 유저에게 주어지는 보상정보를 관리합니다. <br>
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					mtype: "POST",
					datatype: "json",	//metaKey, minuteFromLastLogin, rewardType, reward, msg_ko, msg_en, modYmdt, modId  '우편메시지(ko)(사용안함) <br>(Message Korean)', '우편메시지(en)(사용안함) <br>(Message English)', , 
					colNames:[' ', 'Key', '마지막 로그인으로부터 분 <br>(Minute from Last Login)', '보상분류 <br>(RewardType)', '보상 <br>(Reward)', '수정일시 <br>(Modification Date)', '수정ID <br>(Modification ID)' ],					
					colModel:[
						...
						{name:'metaKey', index:'metaKey', width:260, fixed:true, sorttype:"integer", hidden: true, key: true, editable: false, searchoptions:{sopt: ['eq']}},
						{name:'minuteFromLastLogin', index:'minuteFromLastLogin', width:170, fixed:true, sorttype:"integer", editable: true, searchoptions:{sopt: ['eq', 'le', 'ge']}, sortable:true},
						{name:'rewardType', index:'rewardType', width:150, fixed:true, sorttype:"integer", formatter:"select", editable: true, edittype:"select", editoptions:{value:"${RewardTypeOpts}"}, sortable:true},
						{name:'reward', index:'reward', width:150, fixed:true, sorttype:"integer", editable: true, searchoptions:{sopt: ['eq']}, sortable:true},
