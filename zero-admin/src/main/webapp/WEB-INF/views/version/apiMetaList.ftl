<@layout.extends name="/layout/base.ftl">
	...
	<@layout.put block="page-javascript-inline">
		...
		<script type="text/javascript">
			...
			var serverUrl = {
				gridUrl : "${rc.contextPath}/version/api-meta/grid",
				gridUrlEdit : "${rc.contextPath}/version/api-meta/grid/edit",
				excelUrl : "${rc.contextPath}/version/api-meta/excel",
				csvUrl : "${rc.contextPath}/version/api-meta/csv"
			}
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					mtype: "POST",
					datatype: "json",	// metaKey, name, value, longValue, floatValue, description, modYmdt, modId
					colNames:[' ', 'key', 'name', 'value', 'longValue', 'floatValue', '설명', '수정일시', '수정ID' ],					
					colModel:[
						...
						{name:'metaKey', index:'metaKey', width:160, fixed:true, sorttype:"integer", hidden: true, key: true, editable: false},
						{name:'name', index:'name', width:150, fixed:true, sorttype:"string", editable: true, searchoptions:{sopt: ['eq']}, sortable:true},
						{name:'value', index:'value', width:300, fixed:true, sorttype:"integer", editable: true, searchoptions:{sopt: ['eq']}, sortable:true},
						{name:'longValue', index:'longValue', width:80, fixed:true, sorttype:"integer", editable: true, searchoptions:{sopt: ['eq']}, sortable:true},
						{name:'floatValue', index:'floatValue', width:80, fixed:true, sorttype:"integer", editable: true, searchoptions:{sopt: ['eq']}, sortable:true},
						{name:'description', index:'description', width:350, fixed:true, sorttype:"string", editable: true, searchoptions:{sopt: ['eq']}, sortable:true},
