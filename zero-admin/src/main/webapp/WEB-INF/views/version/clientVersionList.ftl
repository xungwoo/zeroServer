<@layout.extends name="/layout/base.ftl">
	...
	<@layout.put block="page-javascript-inline">
		...
		<script type="text/javascript">
			...
			var serverUrl = {
				gridUrl : "${rc.contextPath}/version/client-info/grid",
				gridUrlEdit : "${rc.contextPath}/version/client-info/grid/edit",
				excelUrl : "${rc.contextPath}/version/client-info/excel",
				csvUrl : "${rc.contextPath}/version/client-info/csv"
			}
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					mtype: "POST",
					datatype: "json",
					colNames:[' ', 'Key', 'Version', 'Platform', '해쉬값', '유효버전여부', ],					
					colModel:[
						...
						{name:'clientKey', index:'clientKey', width:260, fixed:true, sorttype:"integer", hidden: true, key: true, editable: false, searchoptions:{sopt: ['eq']}},
						{name:'clientVersion', index:'clientVersion', width:120, fixed:true, sorttype:"integer", editable: true, searchoptions:{sopt: ['eq','ge','le']}, sortable:false},
						{name:'clientPlatform', index:'clientPlatform', width:120, fixed:true, sorttype:"integer", editable: true, edittype:"select", editoptions:{defaultValue:'android:android', value:"ios:ios;android:android"}, searchoptions:{sopt: ['eq','ge','le']}, sortable:false},
						{name:'clientHash', index:'clientHash', width:300, fixed:true, sorttype:"integer", editable: true, sortable:false, search:false},
						{name:'isValid', index:'isValid', width:150, fixed:true, sorttype:"integer", editable: true, edittype:"select", editoptions:{defaultValue:'TRUE:true', value:"TRUE:true;FALSE:false"}, sortable:false, search:false},
					], 
					search : {
						caption: "Search...",
						Find: "Find",
