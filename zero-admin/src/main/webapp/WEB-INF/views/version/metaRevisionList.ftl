<@layout.extends name="/layout/base.ftl">
						...
						<div class="page-header">
							<h1>
								...
								<small>
									...
									Meta 정보의 Revision 을 관리합니다.<br>
									<span style="color:red;">※ 메타정보를 수정한 후 Revision 값을 변경(증가)하면 캐싱된 메타정보가 갱신됩니다.</span>
								</small>
							</h1>
						</div><!-- /.page-header -->
	...
	<@layout.put block="page-javascript-inline">
		...
		<script type="text/javascript">
			...
			var serverUrl = {
				gridUrl : "${rc.contextPath}/version/meta-revision/grid",
				gridUrlEdit : "${rc.contextPath}/version/meta-revision/grid/edit",
				excelUrl : "${rc.contextPath}/version/meta-revision/excel",
				csvUrl : "${rc.contextPath}/version/meta-revision/csv"
			}
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					mtype: "POST",
					datatype: "json",
					colNames:[' ', 'key', 'MetaName', 'API Url<br>(Description)', 'Revision', '수정일시', '수정ID' ],					
					colModel:[
						...
						{name:'revisionKey', index:'revisionKey', width:160, fixed:true, sorttype:"integer", hidden: true, key: true, editable: false},
						{name:'metaName', index:'metaName', width:160, fixed:true, sorttype:"integer", editable: true, searchoptions:{sopt: ['eq']}},
						{name:'metaUrl', index:'metaUrl', width:300, fixed:true, sorttype:"integer", editable: true, searchoptions:{sopt: ['eq']}, sortable:true},
						{name:'revision', index:'revision', width:80, fixed:true, sorttype:"integer", editable: true, searchoptions:{sopt: ['eq']}, sortable:true},
