<@layout.extends name="/layout/base.ftl">
						...
						<div class="page-header">
							<h1>
								...
								<small>
									...
									Client에서 접속하는 Server url들을 관리합니다.<br>
									<span style="color:red;">※ 서버 URL에는 "http://" , port 번호가 포함되어야 하며 "/" 로 끝나야합니다.</span>
								</small>
							</h1>
						</div><!-- /.page-header -->
	...
	<@layout.put block="page-javascript-inline">
		...
		<script type="text/javascript">
			...
			var serverUrl = {
				gridUrl : "${rc.contextPath}/version/server-url/grid",
				gridUrlEdit : "${rc.contextPath}/version/server-url/grid/edit",
				excelUrl : "${rc.contextPath}/version/server-url/excel",
				csvUrl : "${rc.contextPath}/version/server-url/csv"
			}
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					mtype: "POST",
					datatype: "json",
					colNames:[' ', 'Key', 'url', 'name', 'description', '수정일시', '수정ID' ],					
					colModel:[
						...
						{name:'serverKey', index:'serverKey', width:260, fixed:true, sorttype:"integer", hidden: true, key: true, editable: false, searchoptions:{sopt: ['eq']}},
						{name:'url', index:'url', width:300, fixed:true, sorttype:"integer", editable: true, searchoptions:{sopt: ['eq']}, sortable:false},
						{name:'name', index:'name', width:120, fixed:true, sorttype:"integer", editable: true, searchoptions:{sopt: ['eq']}, sortable:false},
						{name:'description', index:'description', width:300, fixed:true, sorttype:"integer", editable: true, searchoptions:{sopt: ['eq']}, sortable:false},
