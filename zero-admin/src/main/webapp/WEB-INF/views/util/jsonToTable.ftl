<#import "/tpl/admin.ftl" as layout> <@layout.decoration>
<script type="text/javascript">
<!--

function loadJson() {
	var objectArray = eval($('#jsonSource').val());
	ConvertJsonToTable(objectArray, 'jsonTable', null, 'Download');
}
...
Json Source : <textarea id="jsonSource"></textarea><br><br>
<div class="control-group">
	<div class="controls">
		<button id="jsonToTable" type="button" class="btn btn-primary" onclick="javascript:loadJson()">Json to Table</button>
	</div>
</div>
