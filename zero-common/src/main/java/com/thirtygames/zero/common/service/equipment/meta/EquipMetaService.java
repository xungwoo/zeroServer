...
public interface EquipMetaService extends MetaService<EquipmentMeta, String> {
	...
	public int getBossRaidEquipReward(int category, int gradeRatio, int bossUnitLevel);
