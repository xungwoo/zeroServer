...
public abstract class AdminLogServiceImpl<M extends GenericMapper<T, K>, T, K> extends GenericServiceImpl<M, T, K> implements GenericService<T, K> {
	
	@Override
	@DataSourceAnnotation(DataSourceType.ZERO_DYNAMIC_LOG)
	...
	public T get(K id) {
		...
		T entity = null;		
		for (DataSource dataSourceType : DataSource.LOG_SHARDS) {
