...
public interface AdmEquipMetaMapper extends GenericMapper<EquipmentMeta, String> {
	...
	public int getRandomMergedEquipmentType(@Param("grade")int mergedGrade, @Param("eqClass")int mergedClass);
